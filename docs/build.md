...
Ledger exposes a public seeded-keygen API. The Cargo configuration reserves extra stack on
Nano X by setting its heap to 2 KiB; this follows the ML-DSA Rust SDK guidance for the device's
28 KiB SRAM.
